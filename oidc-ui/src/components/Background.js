    ...
    >
      <div className="flex flex-col flex-grow lg:px-5 md:px-4 sm:px-3 px-3">
        <div className="w-full">
          ...
          <h1 className="content-non-visible flex text-center justify-center title-font sm:text-base text-base mb-3 font-small text-gray-400" id="login-subheader">{subheading}</h1>
        </div>
